...
<img src="picture/bannergameproduction.png" width="" height="" id="bannerprogramme"></img>
...
<h1>Choose Your Difficulty</h1>
    ...
    <div class="isicontentprogramme">
        <img src="picture/gameproduction.png" width="100%" height="" id="isicontentprogramme"></img>
        @if (Auth::check()) 
