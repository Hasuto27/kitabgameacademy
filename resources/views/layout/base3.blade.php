                ...
                @else
                    <div class="navbar-notifcart">
                        ...
                        <div class="navbar-notifcart-satuan">
                         <a href="{{ url('/notification') }}"><img src="/picture/notif.png" alt="Alternate Text" /></a>
                            @if($countnotif=DB::table('notification')->where('user_id',Auth::user()->id)->count() !=0)  
                         <p>{{$countnotif}}</p>
                            @endif
                        </div>
                    ...
                    <div class="dropdown" id="dropdownnama">
                        <div class="navbar-profile">
                            <img src="/picture/profilepic.png" height="40px" widht="40px"></img>
                            <p>{{Auth::user()->name}} (Lv.{{Auth::user()->level}})</p>
                            <p>MR Poin :{{Auth::user()->millitaryration}}</p>
                        </div>
...
@endif
    <div class="pagecontain-dashboard">
        <div class="pagecontain-dashboard-kiri">
            <ul>
                <li class="listmenudashboard"><a style=" display:block;" href="/">Dashboard</a></li>

            </ul>
        </div>
        <div class="pagecontain-dashboard-kanan">
                @yield('container')
                  <footer>
        <div class="footer">
            <ul>
